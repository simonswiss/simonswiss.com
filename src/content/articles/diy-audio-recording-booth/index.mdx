...
export const image1 = '/src/content/articles/diy-audio-recording-booth/booth-build-1.webp'
export const image2 = '/src/content/articles/diy-audio-recording-booth/booth-build-2.webp'
export const image3 = '/src/content/articles/diy-audio-recording-booth/booth-build-3.webp'
export const image4 = '/src/content/articles/diy-audio-recording-booth/booth-build-4.webp'
export const image5 = '/src/content/articles/diy-audio-recording-booth/booth-build-5.webp'
...
<div class="grid sm:grid-cols-2 gap-x-8 gap-y-4 not-prose">
  <CaptionImage src={image1} alt="DIY recording booth creation" />
  <CaptionImage src={image2} alt="DIY recording booth creation" />
  <CaptionImage src={image3} alt="DIY recording booth creation" />
  <CaptionImage src={image4} alt="DIY recording booth creation" />
  <CaptionImage src={image5} alt="DIY recording booth creation" />
</div>
...
<YouTubeVideo videoId="JqCs1pdmf9o" />

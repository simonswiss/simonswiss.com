...
<CaptionImage src="/src/assets/images/articles/tailwind-v4-multi-theme/theming-1.png" alt="Minimal theming strategy in Tailwind v4">
...
<CaptionImage src="/src/assets/images/articles/tailwind-v4-multi-theme/theming-2.png" alt="CSS class hover showing the HEX value consumption">
...
<CaptionImage src="/src/assets/images/articles/tailwind-v4-multi-theme/theming-3.png" alt="Advanced theming setup">
...
This all means that some parts of the [Multi-Theme Strategy workshop](https://www.protailwind.com/workshops/multi-theme-strategy) *could* be simplified.

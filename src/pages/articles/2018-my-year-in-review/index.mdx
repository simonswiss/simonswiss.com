...
import dotall from './dotall.png'
import bball from './league-title.jpg'

export const image = dotall
...
<CaptionImage src={dotall} alt="DotAll CraftCMS conference 2018 logo" width={600} height={400}>

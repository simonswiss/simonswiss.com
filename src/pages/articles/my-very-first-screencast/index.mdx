...
import wardrobe from './wardrobe-booth.jpg'
...
<IntroText>
  I am a self-taught front-end developer. I owe a large portion of what I know to some incredible
  individuals who took the time to create video tutorials — paid or free — and make them available
  to the world.
</IntroText>
...
<CaptionImage src={wardrobe} alt="Wardrobe recording booth" width={600} height={799}>
